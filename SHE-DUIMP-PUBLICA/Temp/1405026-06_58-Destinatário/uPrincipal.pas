...
begin
  ...
  {
   use esses componentes para preencher a taga <dest>
   <dest>
     ...
     <xNome> EditDestxNome
     <enderDest>
       <xLgr> EditDestenderDestxLgr
       <nro> EditDestenderDestnro
       <xCpl> EditDestenderDestxCpl
       <xBairro> EditDestenderDestxBairro
       <cMun> EditDestenderDestcMun
       <xMun> EditDestenderDestxMun
       <UF> EditDestenderDestUF
       <CEP>EditDestenderDestCEP
       <cPais> EditDestenderDestcPais
       <xPais> EditDestenderDestxPais
       <fone> EditDestenderDestFone
     </enderDest>
     <indIEDest> EditDestindIEDest
