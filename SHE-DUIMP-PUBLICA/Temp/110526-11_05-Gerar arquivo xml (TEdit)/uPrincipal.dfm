object Form1: TForm1
  ...
  object ScrollBox1: TScrollBox
    ...
    object PCPrincipal: TdxPageControl
      ...
      TabPosition = dxtpTop
      TabWidth = 0
      object TSCertificado: TdxTabSheet
        Caption = 'Certificado'
        object LabelPcceClientId: TLabel
          Left = 10
          Top = 36
          Width = 38
          Height = 13
        ...
        object LabelPcceClientSecret: TLabel
          Left = 10
          Top = 60
          Width = 60
          Height = 13
        ...
        object LabelNumeroDuimp: TLabel
          Left = 10
          Top = 84
          Width = 50
          Height = 13
        ...
        object LabelVersaoDuimp: TLabel
          Left = 10
          Top = 108
          Width = 33
          Height = 13
        ...
        object LabelCertificadoNoSerie: TLabel
          Left = 10
          Top = 12
          Width = 50
          Height = 13
        ...
        object EditPcceClientId: TEdit
          Left = 90
          Top = 32
          Width = 250
          Height = 21
          TabOrder = 1
          Text = 'wYcU-WjrQB9DpwtBdUJtTJDH1gYBnkaX'
        end
        object EditPcceClientSecret: TEdit
          Left = 90
          Top = 56
          Width = 250
          Height = 21
          TabOrder = 2
          Text = 'e1eS-TuJKEifjQ_TWnCEK_TOTVty_nyF'
        end
        object EditCertificadoNoSerie: TEdit
          Left = 90
          Top = 8
          Width = 250
          Height = 21
      ...
      object TSIdentificacao: TdxTabSheet
        Caption = 'Identifica'#231#227'o'
        object LabelIdecUF: TLabel
          Left = 10
          Top = 9
          Width = 65
          Height = 13
        ...
        object LabelIdefinNFe: TLabel
          Left = 10
          Top = 225
          Width = 87
          Height = 13
          Caption = 'Tipo de Finalidade'
        end
        object LabelIdeindFinal: TLabel
          Left = 10
          Top = 249
          Width = 97
          Height = 13
          Caption = 'Indicativo Finalidade'
        end
        object LabelIdeindPres: TLabel
          Left = 10
          Top = 273
          Width = 35
          Height = 13
        ...
        object LabelIdeindIntermed: TLabel
          Left = 10
          Top = 297
          Width = 55
          Height = 13
        ...
        object EditIdeindIntermed: TEdit
          Left = 130
          Top = 293
          Width = 50
          Height = 21
      ...
      object TSEmitente: TdxTabSheet
        Caption = 'Emitente'
        object LabelEmitCNPJ: TLabel
          Left = 10
          Top = 9
          Width = 27
          Height = 13
        ...
        object LabelEmitenderEmitxLgr: TLabel
          Left = 10
          Top = 81
          Width = 54
          Height = 13
        ...
        object LabelEmitenderEmitnro: TLabel
          Left = 10
          Top = 105
          Width = 37
          Height = 13
        ...
        object LabelEmitenderEmitxBairro: TLabel
          Left = 10
          Top = 129
          Width = 27
          Height = 13
        ...
        object LabelEmitenderEmitcMun: TLabel
          Left = 10
          Top = 153
          Width = 81
          Height = 13
        ...
        object LabelEmitenderEmitxMun: TLabel
          Left = 10
          Top = 177
          Width = 47
          Height = 13
        ...
        object LabelEmitenderEmitUF: TLabel
          Left = 10
          Top = 201
          Width = 14
          Height = 13
        ...
        object LabelEmitenderEmitCEP: TLabel
          Left = 10
          Top = 225
          Width = 21
          Height = 13
        ...
        object LabelEmitenderEmitcPais: TLabel
          Left = 10
          Top = 249
          Width = 73
          Height = 13
        ...
        object LabelEmitenderEmitxPais: TLabel
          Left = 10
          Top = 273
          Width = 68
          Height = 13
        ...
        object LabelEmitenderEmitFone: TLabel
          Left = 10
          Top = 297
          Width = 24
          Height = 13
        ...
        object EditEmitxNome: TEdit
          Left = 114
          Top = 29
          Width = 300
          Height = 21
          TabOrder = 1
          Text = 'TEXTIL E CONFECCOES OTIMOTEX LTDA'
        end
        object EditEmitxFant: TEdit
          Left = 114
          Top = 53
          Width = 300
          Height = 21
        ...
        object EditEmitenderEmitxLgr: TEdit
          Left = 114
          Top = 77
          Width = 300
          Height = 21
          TabOrder = 3
          Text = 'Rua Visconde de Parna'#237'ba'
        end
        object EditEmitenderEmitnro: TEdit
          Left = 114
          Top = 101
          Width = 300
          Height = 21
        ...
        object EditEmitenderEmitxBairro: TEdit
          Left = 114
          Top = 125
          Width = 300
          Height = 21
        ...
        object EditEmitenderEmitcMun: TEdit
          Left = 114
          Top = 149
          Width = 300
          Height = 21
        ...
        object EditEmitenderEmitxMun: TEdit
          Left = 114
          Top = 173
          Width = 300
          Height = 21
        ...
        object EditEmitenderEmitUF: TEdit
          Left = 114
          Top = 197
          Width = 300
          Height = 21
        ...
        object EditEmitenderEmitCEP: TEdit
          Left = 114
          Top = 221
          Width = 300
          Height = 21
        ...
        object EditEmitenderEmitcPais: TEdit
          Left = 114
          Top = 245
          Width = 300
          Height = 21
        ...
        object EditEmitenderEmitxPais: TEdit
          Left = 114
          Top = 269
          Width = 300
          Height = 21
        ...
        object EditEmitenderEmitFone: TEdit
          Left = 114
          Top = 293
          Width = 300
          Height = 21
      ...
      object TSDestinatario: TdxTabSheet
        ...
        object EditDestenderDestxLgr: TEdit
          Left = 114
          Top = 53
          Width = 300
          Height = 21
        ...
        object EditDestenderDestnro: TEdit
          Left = 114
          Top = 77
          Width = 300
          Height = 21
        ...
        object EditDestenderDestxBairro: TEdit
          Left = 114
          Top = 125
          Width = 300
          Height = 21
        ...
        object EditDestenderDestcMun: TEdit
          Left = 114
          Top = 149
          Width = 300
          Height = 21
        ...
        object EditDestenderDestxMun: TEdit
          Left = 114
          Top = 173
          Width = 300
          Height = 21
        ...
        object EditDestenderDestUF: TEdit
          Left = 114
          Top = 197
          Width = 300
          Height = 21
        ...
        object EditDestenderDestCEP: TEdit
          Left = 114
          Top = 221
          Width = 300
          Height = 21
        ...
        object EditDestenderDestcPais: TEdit
          Left = 114
          Top = 245
          Width = 300
          Height = 21
        ...
        object EditDestenderDestxPais: TEdit
          Left = 114
          Top = 269
          Width = 300
          Height = 21
        ...
        object EditDestenderDestFone: TEdit
          Left = 114
          Top = 293
          Width = 300
          Height = 21
        ...
        object EditDestindIEDest: TEdit
          Left = 114
          Top = 317
          Width = 300
          Height = 21
        ...
        object EditDestenderDestxCpl: TEdit
          Left = 114
          Top = 101
          Width = 300
          Height = 21
      ...
      object TSTransportadora: TdxTabSheet
        Caption = 'Transportadora'
        object LabelTranspCNPJ: TLabel
          Left = 10
          Top = 9
          Width = 27
          Height = 13
        ...
        object LabelTranspxNome: TLabel
          Left = 10
          Top = 33
          Width = 63
          Height = 13
        ...
        object LabelTranspxEnder: TLabel
          Left = 10
          Top = 81
          Width = 46
          Height = 13
        ...
        object EditTranspxNome: TEdit
          Left = 114
          Top = 29
          Width = 300
          Height = 21
          TabOrder = 1
          Text = 'ATP OLIVEIRA TRANSPORTES LTDA'
        end
        object EditTranspxEnder: TEdit
          Left = 114
          Top = 77
          Width = 300
          Height = 21
          TabOrder = 2
          Text = '. RUA VISCONDE DE EMBARE, . . .'
        end
        object EditTranspxMun: TEdit
          Left = 114
          Top = 101
          Width = 300
          Height = 21
      ...
      object TSProdutos: TdxTabSheet
        Caption = 'Detalhes dos Produtos'
        object LabeldetprodCFOP: TLabel
          Left = 10
          Top = 9
          Width = 28
          Height = 13
        ...
        object LabeldetprodUFDesemb: TLabel
          Left = 10
          Top = 33
          Width = 83
          Height = 13
        ...
        object LabelICMSorig: TLabel
          Left = 10
          Top = 57
          Width = 114
          Height = 13
          Caption = 'Origem das Mercadorias'
        end
        object LabelPICMS: TLabel
          Left = 10
          Top = 81
          Width = 80
          Height = 13
        ...
        object EditdetprodUFDesemb: TEdit
          Left = 130
          Top = 29
          Width = 50
          Height = 21
  ...
  object BTNConsultaDUIMP: TButton
    ...
    Width = 150
    Height = 25
    Caption = 'Consultar DUIMP'
    TabOrder = 3
    OnClick = BTNConsultaDUIMPClick
  end
  object BTNGeraNFeXML: TButton
    Left = 10
    Top = 72
    Width = 150
    Height = 25
    Caption = 'Gerar arquivo XML'
    TabOrder = 4
    OnClick = BTNGeraNFeXMLClick
  end
end
